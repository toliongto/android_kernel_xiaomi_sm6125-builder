...
add_patches() {
    ...
    echo "CONFIG_CPU_FREQ_GOV_ONDEMAND=y" >> $MAIN_DEFCONFIG
    echo "CONFIG_CPU_FREQ_GOV_CONSERVATIVE=y" >> $MAIN_DEFCONFIG
    echo "CONFIG_CPU_FREQ_GOV_INTERACTIVE=y" >> $MAIN_DEFCONFIG
    echo "# CONFIG_INIT_STACK_NONE is not set" >> $MAIN_DEFCONFIG
    echo "CONFIG_INIT_STACK_ALL_ZERO=y" >> $MAIN_DEFCONFIG
    echo "CONFIG_INIT_ON_ALLOC_DEFAULT_ON=y" >> $MAIN_DEFCONFIG
